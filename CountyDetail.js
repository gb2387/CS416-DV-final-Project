...
svg.append("text")
  ...
  .append("rect")
    ...
    var rect = svg.append('rect').transition().duration(1000).attr("x", 150).attr("y", -50).attr("width", 370)
    .attr("height", 30).attr("fill","lightblue").attr("stroke","black").text("As of July 2021")

svg.append("g").append("text").transition().duration(1000).attr("id","annotation").attr("x", 210).attr("y", -30)
	.text("All the Counties of selected state").attr("font-size", "14px").attr("fill", "black").attr("font-weight","bold")
